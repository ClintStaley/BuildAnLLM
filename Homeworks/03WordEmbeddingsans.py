...
#
# A3: 66 provides only 8 full batches, losing 2 datapoints
...
# 
# Ans: if torch.equal(xb[:, 1:], yb[:, :-1])  (or allclose)
#
...
# it.
#
# A7: True, and it's the pair of lines, really, though one could argue the second
...
# cos(king, prince), each to 4 decimal places? Is the tie from Q1 still
# present under cosine similarity? (True/False)
#
# A2: 1 and .8165 respectively.  False
